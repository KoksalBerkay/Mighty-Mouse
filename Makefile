...
build:
	clang++ main.mm GestureEngine.mm Preferences.mm GestureInterpreter.cpp -o mighty_mouse \
	-fobjc-arc \
    -I./include \
...
test:
	mkdir -p work
	clang++ GestureInterpreter.cpp GestureInterpreterTests.cpp -o work/gesture_interpreter_tests -arch arm64
